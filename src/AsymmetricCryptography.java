...
public class AsymmetricCryptography {
    ...
    public String encryptText(String msg, PublicKey key)
        ...
        this.cipher.init(Cipher.ENCRYPT_MODE, key);
        return new String(Base64.encodeBase64(cipher.doFinal(msg.getBytes("UTF-8"))));
    }
    ...
    public String decryptText(String msg, PrivateKey key)
        ...
        this.cipher.init(Cipher.DECRYPT_MODE, key);
        return new String(cipher.doFinal(Base64.decodeBase64(msg.getBytes(StandardCharsets.UTF_8))), "UTF-8");
    }
